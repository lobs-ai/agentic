...
export const findFilesToolDefinition = {
    name: "find_files",
    description: "Find files and directories using fd. Fast, respects .gitignore by default. " +
    ...
    input_schema: {
        ...
        properties: {
            pattern: {
                type: "string",
                description: "Search pattern (regex by default, or literal filename). Leave empty to find all files.",
            },
            path: {
                type: "string",
...
// ── Tool Implementation ──────────────────────────────────────────────────────
export async function findFilesTool(params, cwd) {

...
export const codeSearchToolDefinition = {
    name: "code_search",
    description: "Search code with context. Returns matches with surrounding lines for better understanding. " +
    ...
    input_schema: {
        ...
        properties: {
            ...
            language: {
                type: "string",
                description: "Filter by language/file type (e.g. 'ts', 'python', 'rust', 'go'). Maps to ripgrep's --type flag.",
            },
            context_lines: {
                type: "number",
...
// ── Tool Implementation ──────────────────────────────────────────────────────
export async function codeSearchTool(params, cwd) {
    ...
    const contextLines = params.context_lines ?? DEFAULT_CONTEXT;
    const maxResults = params.max_results ?? DEFAULT_MAX_RESULTS;
    const wordMatch = params.word_match;
